...
void GeneralGame::desenhaRetangulos() {
...
void GeneralGame::gerarBarcoV(int tamNavio) {
	srand(p);
	bool valido = false;
	int posx = rand() % 10;
	int posy = rand() % 10;
...
void GeneralGame::gerarFluty1(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
	if (tamNavio == 4) {
...
void GeneralGame::gerarFluty2(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
	if (tamNavio == 4) {
...
void GeneralGame::gerarVeleiro1(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarVeleiro2(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarVeleiro3(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarVeleiro4(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarTerco1(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarTerco2(int tamNavio) {
	srand(p);
	int posx, posy;
	bool valido = false;
...
void GeneralGame::gerarBarcoH(int tamNavio) {
	int posx, posy;
	srand(p);
	bool valido = false;
...
void GeneralGame::Game() {
	...
	Barco01.loadFromFile("../assets/barcos/iconbarco2.png");
	Barco02.loadFromFile("../assets/barcos/barco6.png");
	Barco03.loadFromFile("../assets/barcos/barco4.png");
	Barco04.loadFromFile("../assets/barcos/barco5.png");
	Barco05.loadFromFile("../assets/barcos/barco1.png");
	music->stop();
	c = 999;
	...
	IconCaravela.setTexture(Barco01);
	IconCaravela.setPosition(838, 313);
	IconCaravela.setScale(0.1, 0.1);
	IconCaravela.setColor(sf::Color::White);

	IconVeleiro.setTexture(Barco05);
	IconVeleiro.setPosition(878, 203);
	IconVeleiro.setScale(0.08, 0.08);
	IconVeleiro.setColor(sf::Color::White);

	Iconterco.setTexture(Barco02);
	Iconterco.setPosition(838, 413);
	Iconterco.setScale(0.1, 0.1);
	Iconterco.setColor(sf::Color::White);

	Iconterco2.setTexture(Barco03);
	Iconterco2.setPosition(1197, 393);
	Iconterco2.setScale(0.1, 0.1);
	Iconterco2.setColor(sf::Color::White);

	IconFluty.setTexture(Barco04);
	IconFluty.setPosition(878, 503);
	IconFluty.setScale(0.1, 0.1);
	IconFluty.setColor(sf::Color::White);

	XImage.loadFromFile("../assets/x.png");
	Fire.loadFromFile("../assets/barcos/fire.png");
	Fire.setSmooth(true);
	...
	//carrega background
	image.loadFromFile("../assets/part3.png");
	...
	if (Veleiropoints == 4 && Caravelapoints == 1 && Tercopoints == 3
			&& Flutypoints == 2) {
		VitoriaFinal = true;
		ChaveGame = false;
		ChaveFinalGame = true;
...
void GeneralGame::ClearMinipoints() {
	Iconterco.setColor(sf::Color::Transparent);
	Iconterco2.setColor(sf::Color::Transparent);
	IconFluty.setColor(sf::Color::Transparent);
	IconCaravela.setColor(sf::Color::Transparent);
	IconVeleiro.setColor(sf::Color::Transparent);
}
//TELA FINAL
void GeneralGame::FinalGame() {
	Clear();
	ClearMinipoints();
	...
	image.loadFromFile("../assets/part4.png");
	textTitulo.setFont(*font);
